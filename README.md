...
- Si un bot possède un problème sur votre discord ou une erreur de de code, merci de le signaler <a href="https://github.com/AnthoYt/Bot-Discord/issues">Ici</a> !
...
⚠️ Attention si message d'erreur, merci d'aller sur <a href="https://chatgpt.com/">notre Technicien pour les bots</a> 😁😁
...
<img width="1090" height="600" alt="image" src="https://github.com/user-attachments/assets/73030817-0d9a-40e6-8066-d72141a84fbc" />



# Contacts :

- <a href="https://youtube.com/@Royale_Antho">Youtube</a>
- <a href="https://discord.com/invite/ad7aMevNMx">Discord</a>
- <a href="https://www.twitch.tv/twitch_antho_off">Twitch</a>




**IDÉES LIÉES AUX JEUX VIDÉO
Tryhard vs Communauté**

Tes viewers doivent réaliser un défi sur un jeu (clips, screenshots, records…)
Exemples :

Le plus beau clutch
Le fail le plus drôle
La meilleure construction (Minecraft)
Le kill le plus “WTF”
Tu réagis en live


**😂 CONCEPTS FUN NON-LIÉS AUX JEUX
“JE RÉAGIS À VOS… (version Discord)”**
Tu ouvres un salon où les membres postent :

leurs setups
leurs animaux
leurs memes
leur bureau (le plus propre / le plus dégueu)
Tu commentes tout en stream.

**“Vos histoires / confessions anonymes”
Les gens t’envoient en privé (ou via un bot anonyme) :**

leurs histoires gênantes
leurs crush
leurs pires moments à l’école
leur pire excuse donnée à un prof

**“Qui est le menteur ?”
Les membres t’envoient :**

3 affirmations → 2 vraies / 1 fausse
Toi tu dois deviner laquelle est fausse en live.
Très drôle si les membres te piégeront bien.
Et tu réagis en live (sans exposer leur pseudo bien sûr).
